...
// 		ud.createUser(u3);
		...
		User u1 = ud.getUserById(1);
 		...
 		Expense e1 = new Expense("Rent", 100, Date.valueOf("2018-09-10"), "", u1);
 		Expense e2 = new Expense("Power Bill", 100, Date.valueOf("2018-09-10"), "", u1);
 		Expense e3 = new Expense("Rent", 100, Date.valueOf("2018-10-10"), "", u1);
